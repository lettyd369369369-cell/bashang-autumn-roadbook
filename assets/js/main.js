...
(function () {
  ...
  /* ================= 天气实时更新 =================
     打开页面自动拉 Open-Meteo 最新预报，刷新每天卡片的「天气」行；
     网络失败/离线时保留 HTML 里写入的快照。手动点按钮可再刷。 */
  var WMO = {
  ...
  // 与页面 13 张日卡一一对应：当天代表性地点（多为当晚住宿地）+ 日期
  var DAYS = [
    { lat:34.379, lon:118.345, date:'2026-09-25', at:'夜宿新沂' },
    { lat:36.651, lon:117.120, date:'2026-09-26', at:'夜宿济南' },
    { lat:39.303, lon:117.416, date:'2026-09-27', at:'傍晚·天津' },
    { lat:40.951, lon:117.963, date:'2026-09-28', at:'夜宿承德' },
    { lat:42.367, lon:117.481, date:'2026-09-29', at:'塞罕坝' },
    { lat:42.435, lon:117.533, date:'2026-09-30', at:'乌兰布统' },
    { lat:42.435, lon:117.533, date:'2026-10-01', at:'乌兰布统' },
    { lat:43.242, lon:117.908, date:'2026-10-02', at:'热水塘' },
    { lat:43.510, lon:117.600, date:'2026-10-03', at:'热阿线·黄岗梁' },
    { lat:42.188, lon:116.489, date:'2026-10-04', at:'多伦→张家口' },
    { lat:37.436, lon:116.357, date:'2026-10-05', at:'夜宿德州' },
    { lat:35.099, lon:117.166, date:'2026-10-06', at:'夜宿滕州' },
    { lat:32.455, lon:119.923, date:'2026-10-07', at:'回到泰州' }
  ];
  ...
  function refresh(manual) {
    ...
    fetch(url).then(function (r) {
      ...
      if (wxNote) {
        ...
        wxNote.textContent = '已更新 ' + hh + ':' + mm + ' · 覆盖 ' + ok + '/13 天' + (ok < 13 ? '（其余保留快照）' : '');
      }
    }).catch(function () {
